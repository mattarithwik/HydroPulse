...
export type Forecast={id:string;target_id:string;issued_at:string;newest_observation_at:string;observation_age_minutes:number;stage_model_version:string;model_status:string;freshness:string;degradation_reasons:string[];stage:Point[];maximum_stage:Point[];threshold_crossings:ThresholdCrossing[];horizon_model_mapping:Record<string,string>};
