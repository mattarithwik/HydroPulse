...
function App(){
 ...
 return <main><header><div><span className="eyebrow">LOCAL RIVER INTELLIGENCE</span><h1>Hydro<span>Pulse</span></h1></div><div className="live"><i/> Local system</div></header>
  ...
  <section className="split"><div className="panel"><span className="eyebrow">THRESHOLD CONTEXT</span><h3>Height, not flood probability</h3><p className="status">Minor stage: {basin.flood_stage_ft} ft</p><p>HydroPulse predicts gauge height and uncertainty. It does not estimate a chance of flooding or issue warnings.</p></div><div className="panel"><span className="eyebrow">PROVENANCE</span><h3>Forecast contract</h3><dl><dt>Stage model</dt><dd>{forecast.stage_model_version}</dd><dt>Model status</dt><dd>{forecast.model_status}</dd><dt>48/72h inputs</dt><dd>No future NWP</dd><dt>Snapshot</dt><dd>{forecast.id.slice(0,12)}</dd></dl></div></section></>}
